...
document.addEventListener('DOMContentLoaded', function () {
	var logo = document.querySelector('.ayLogoContainer .logoResim img'); // Ýkinci resim için img seçimi
	var logoMetin = document.querySelector('.ayLogoContainer .logoMetin img'); // Ýlk resim için img seçimi
	logo.style.animation = 'animBir 3s forwards';
	logoMetin.style.animation = 'animIki 3s forwards';
});
document.addEventListener('DOMContentLoaded', function () {
	var logoMetin = document.querySelector('.ayLogoContainer .logoMetin img');
	logoMetin.addEventListener('mouseenter', function () {
		logoMetin.style.animation = 'animIki 3s forwards';
	});
	logoMetin.addEventListener('mouseleave', function () {
		// Bu kýsmý boþ býrakýn, böylece animasyonun tamamlanmasýný saðlayýn
	});
	logoMetin.addEventListener('animationend', function () {
		logoMetin.style.animation = '';
	});
});